...
@router.post("/feed", tags=["posts"], response_model=Feed, response_model_exclude_unset=True,
...
@router.delete("/feed/{post_id}", tags=["posts"], status_code=status.HTTP_204_NO_CONTENT)
...
@router.put("/feed/{post_id}/media", tags=["posts"], response_model=None, status_code=status.HTTP_200_OK)
...
@router.put("/feed/{post_id}", tags=["posts"], response_model=None, status_code=status.HTTP_200_OK)
...
@router.post("/feed/{post_id}/like", tags=["posts"], status_code=status.HTTP_204_NO_CONTENT)
...
@router.post("/feed/{post_id}/unlike", tags=["posts"], status_code=status.HTTP_204_NO_CONTENT)
